...
bigassembly.name = "big-assembly-placeable"
...
data.raw["assembling-machine"]["big-assembly-placeable"] = bigassembly

local bigassembly2 = copy(bigassembly)

bigassembly2.name = "big-assembly"
bigassembly2.create_ghost_on_death = false
-- Normal flags for assembly machine: {"placeable-neutral", "placeable-player", "player-creation"}
bigassembly2.flags = {"placeable-neutral", "placeable-player", "not-deconstructable", "not-blueprintable"}

table.insert(bigassembly2.resistances, {percent=100, type="poison"})  -- Prevent termite damage

data.raw["assembling-machine"]["big-assembly"] = bigassembly2